// ============================================================================
// DEVWEAVER – Documentation Management
//
...
---
*Generated by DEVWEAVER on ${new Date().toISOString().split('T')[0]}*
`;
...
---
*Updated by DEVWEAVER on ${new Date().toISOString().split('T')[0]}*
`;
...
---
*Updated by DEVWEAVER on ${new Date().toISOString().split('T')[0]} at ${new Date().toTimeString().split(' ')[0]}*
`;
...
---
*Generated by DEVWEAVER on ${new Date().toISOString()}*
`;
    ...
    decisions: [
      {
        ...
        decision: 'Project initialized with DEVWEAVER',
